...
func _init():
	stage_rounds = [
		...
		_get_stageround_10_1(), # normal
		_get_stageround_10_2(), # normal
		_get_stageround_10_3(), # virus + trojan
		
		_get_stageround_10_4(), 
		_get_stageround_10_5(), 
		_get_stageround_10_6(), # adware + worms
		
		_get_stageround_10_7(), 
		_get_stageround_10_8(), 
		_get_stageround_10_9(), # ransom + root
		
		_get_stageround_10_10(),
		_get_stageround_10_11(), 
		_get_stageround_10_12(), # malfilebot
...
func _get_stageround_10_3():
	...
	stageround.end_of_round_gold = 7
	stageround.enemy_damage_multiplier = 1
...
func _get_stageround_10_5():
	...
	stageround.end_of_round_gold = 8
	stageround.enemy_damage_multiplier = 1
	stageround.enemy_health_multiplier = 1
	stageround.enemy_first_damage = 0
...
func _get_stageround_10_7():
	...
	stageround.end_of_round_gold = 9
	stageround.enemy_damage_multiplier = 1
	stageround.enemy_health_multiplier = 1
	stageround.enemy_first_damage = 0
...
func _get_stageround_10_11():
	...
	stageround.end_of_round_gold = 10
	stageround.enemy_damage_multiplier = 1
	stageround.enemy_health_multiplier = 1
	stageround.enemy_first_damage = 0
