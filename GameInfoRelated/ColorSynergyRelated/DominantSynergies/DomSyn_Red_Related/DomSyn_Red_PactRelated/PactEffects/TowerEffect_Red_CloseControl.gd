...
const CloseControl_Explosion_01 = preload("res://GameInfoRelated/ColorSynergyRelated/DominantSynergies/DomSyn_Red_Related/DomSyn_Red_Assets/Pact_CloseControl_Assets/Pact_CloseControl_Explosion_01.png")
const CloseControl_Explosion_02 = preload("res://GameInfoRelated/ColorSynergyRelated/DominantSynergies/DomSyn_Red_Related/DomSyn_Red_Assets/Pact_CloseControl_Assets/Pact_CloseControl_Explosion_02.png")
const CloseControl_Explosion_03 = preload("res://GameInfoRelated/ColorSynergyRelated/DominantSynergies/DomSyn_Red_Related/DomSyn_Red_Assets/Pact_CloseControl_Assets/Pact_CloseControl_Explosion_03.png")
const CloseControl_Explosion_04 = preload("res://GameInfoRelated/ColorSynergyRelated/DominantSynergies/DomSyn_Red_Related/DomSyn_Red_Assets/Pact_CloseControl_Assets/Pact_CloseControl_Explosion_04.png")
const CloseControl_Explosion_05 = preload("res://GameInfoRelated/ColorSynergyRelated/DominantSynergies/DomSyn_Red_Related/DomSyn_Red_Assets/Pact_CloseControl_Assets/Pact_CloseControl_Explosion_05.png")
const CloseControl_Explosion_06 = preload("res://GameInfoRelated/ColorSynergyRelated/DominantSynergies/DomSyn_Red_Related/DomSyn_Red_Assets/Pact_CloseControl_Assets/Pact_CloseControl_Explosion_06.png")
const CloseControl_Explosion_07 = preload("res://GameInfoRelated/ColorSynergyRelated/DominantSynergies/DomSyn_Red_Related/DomSyn_Red_Assets/Pact_CloseControl_Assets/Pact_CloseControl_Explosion_07.png")
const CloseControl_Explosion_08 = preload("res://GameInfoRelated/ColorSynergyRelated/DominantSynergies/DomSyn_Red_Related/DomSyn_Red_Assets/Pact_CloseControl_Assets/Pact_CloseControl_Explosion_08.png")
...
var current_explosion_stun_duration : float
...
var _enemy_stun_effect : EnemyStunEffect
...
func _init().(StoreOfTowerEffectsUUID.RED_PACT_CLOSE_CONTROL_EFFECT):
	pass
...
func _construct_and_add_range_effects():
	if _range_effect == null:
		var _range_modi = PercentModifier.new(StoreOfTowerEffectsUUID.RED_PACT_CLOSE_CONTROL_RANGE_REDUC_EFFECT) 
		_range_modi.percent_amount = range_percent_reduc
		_range_modi.percent_based_on = PercentType.BASE
		
		_range_effect = TowerAttributesEffect.new(TowerAttributesEffect.PERCENT_BASE_RANGE, _range_modi, StoreOfTowerEffectsUUID.RED_PACT_CLOSE_CONTROL_RANGE_REDUC_EFFECT)
		
		_tower.add_tower_effect(_range_effect)

func _construct_stun_effect():
	if _enemy_stun_effect == null:
		_enemy_stun_effect = EnemyStunEffect.new(current_explosion_stun_duration, StoreOfEnemyEffectsUUID.RED_PACT_CLOSE_CONTROL_STUN_EFFECT)
		_enemy_stun_effect.is_from_enemy = false
...
func _construct_and_add_attk_module():
	...
	sprite_frames.add_frame("default", CloseControl_Explosion_01)
	sprite_frames.add_frame("default", CloseControl_Explosion_02)
	sprite_frames.add_frame("default", CloseControl_Explosion_03)
	sprite_frames.add_frame("default", CloseControl_Explosion_04)
	sprite_frames.add_frame("default", CloseControl_Explosion_05)
	sprite_frames.add_frame("default", CloseControl_Explosion_06)
	sprite_frames.add_frame("default", CloseControl_Explosion_07)
	sprite_frames.add_frame("default", CloseControl_Explosion_08)
...
func _create_explosion_around_self():
	...
	aoe_explosion_inst.damage_instance.on_hit_effects[StoreOfTowerEffectsUUID.RED_PACT_CLOSE_CONTROL_STUN_EFFECT] = _enemy_stun_effect._get_copy_scaled_by(1)
...
func _undo_modifications_to_tower(tower):
	var range_effect = _tower.get_tower_effect(StoreOfTowerEffectsUUID.RED_PACT_CLOSE_CONTROL_RANGE_REDUC_EFFECT)
