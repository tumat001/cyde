...
#func request_get_fov_from_polygons_using_threads(polygons, origin, obj_to_receive, obj_receive_method):
#	var calc_queue_info := PolyCalcQueueInfo.new()
#	calc_queue_info.polygons = polygons
#	calc_queue_info.origin = origin
#	calc_queue_info.obj = obj_to_receive
#	calc_queue_info.obj_method = obj_receive_method
#
#	poly_calc_queue.insert(0, calc_queue_info)
#
#	print("requested fov thread -- FOV")
#	request_get_fov_from_polygons_using_threads__queue(calc_queue_info)
#
#func request_get_fov_from_polygons_using_threads__queue(calc_queue):
#	if !poly_calculator_thread.is_alive():
#		print("started thread")
#		var result = poly_calculator_thread.start(self, "_calculate_polygons_on_thread__and_give_to_obj", [calc_queue.polygons, calc_queue.origin, calc_queue.obj, calc_queue.obj_method])
#
#		poly_calc_queue.erase(calc_queue)
#	else:
#		print("thread will be handled later")
#		pass
#
#func _calculate_polygons_on_thread__and_give_to_obj(data : Array):
#	var return_polygons = get_fov_from_polygons(data[0], data[1])
#
#	print("got polygons")
#	var obj_to_receive = data[2]
#	if obj_to_receive != null and is_instance_valid(obj_to_receive):
#		print("called method on obj")
#		obj_to_receive.call(data[3], return_polygons)
#
#	if poly_calc_queue.size() > 0:
#		request_get_fov_from_polygons_using_threads__queue(poly_calc_queue[poly_calc_queue.size() - 1])
#
#class PolyCalcQueueInfo:
#
#	var obj : Object
#	var obj_method : String
#	var polygons
#	var origin
#
